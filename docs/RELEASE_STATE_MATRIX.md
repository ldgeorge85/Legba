...
spine composes bottom-up: EIGHT bounded reasoning UNITS → a mandatory
...
_Generated by `scripts/gen_release_state_matrix.py` from `legba-ui-v3/src/panel-registry/registry.ts` — do not hand-edit between the markers; re-run the script instead. 59 panel kinds registered — 56 live, 3 preview, 16 hidden (a panel can be both live/preview AND hidden — hidden is a navigation-tier flag, not a build state)._
...
| `system.entity_graph` | `system_entity_graph` | operator | — | Entity Graph | no | personal | **live** | yes |
...
| `system.alert_center` | `system_alert_center` | system | — | Alert Center | no | personal, cis | **preview** | yes |
...
| `system.deep_consult` | `system_deep_consult` | system | — | Deep Consult | no | personal | **live** | yes |
| `system.escalations` | `system_escalations` | system | — | Escalation Deliveries | no | personal, cis | **live** | yes |
...
| `system.lineage` | `system_lineage` | system | — | Provenance Lineage | no | personal, cis | **live** | yes |
| `system.notable_structure` | `system_notable_structure` | system | — | Notable Structure | no | personal, cis | **live** | yes |
...
| `system.watchlist` | `system_watchlist` | system | — | Watchlist | no | personal, cis | **live** | yes |
| `v4.assessment` | `v4_assessment` | system | — | World Assessment | no | personal, cis | **live** | no |
| `v4.flow` | `v4_flow` | system | — | Flow Canvas | no | personal, cis | **live** | yes |
| `v4.kpi` | `v4_kpi` | system | — | At a Glance | no | personal, cis | **live** | no |
| `v4.map` | `v4_map` | system | — | World Map | no | personal, cis | **live** | no |
| `v4.timeline` | `v4_timeline` | system | — | Timeline | no | personal, cis | **live** | yes |
| `v4.why` | `v4_why` | system | — | Why · Provenance | no | personal, cis | **live** | yes |
