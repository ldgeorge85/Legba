...
unflattering ones — and repairs what the measurements found. Migrations 0106–0115.
...
- The faithfulness judge no longer has to share a model family with the prose it
  ...
  same-model (self-hostable); the reference instance now runs a cross-family
  judge. Score deltas across a judge swap are explicitly *not* treated as
