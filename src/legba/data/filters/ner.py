...
# The entity-class tier ladder, its predicate maps, cue lists, honorific and
# acronym gazetteers, the R8 canon tier and the W3-C person gate live in the
# sibling module — extracted in 2026-08 when this file crossed the 1,500-line
# gate. RE-EXPORTED, not repointed: `fact_extractor` and the filter tests keep
# importing `_classify_entity_text` from `legba.data.filters.ner` exactly as
# before, because a module split that forces its importers to move is a refactor
# pretending to be a cleanup.
from ._ner_entity_class import _classify_entity_text          # noqa: F401
