...
EXPECTED_YAML_CLASS: dict[str, str] = {
    ...
    "source_rsshub_apnews_haiti.yaml": "reporting",
    "source_rsshub_apnews_niger.yaml": "reporting",
    "source_rsshub_apnews_north_korea.yaml": "reporting",
    "source_rsshub_apnews_taiwan.yaml": "reporting",
    "source_rsshub_focustaiwan.yaml": "reporting",
    "source_rsshub_rfa_korea.yaml": "reporting",
    "source_rsshub_rfi_afrique.yaml": "reporting",
    "source_rsshub_rfi_ameriques.yaml": "reporting",
    # P3-6 Wave-A breadth batch (41 draft no-auth feeds)
    "source_who_disease_outbreak_news.yaml": "official",
    "source_eia_today_in_energy.yaml": "official",
    "source_cgtn_world.yaml": "state_media",
    "source_timesofisrael.yaml": "reporting",
    "source_jpost.yaml": "reporting",
    "source_taipeitimes.yaml": "reporting",
    "source_dailynk.yaml": "reporting",
    "source_38north.yaml": "analysis",
    "source_nhk_world.yaml": "reporting",
    "source_japantimes.yaml": "reporting",
    "source_agenciabrasil.yaml": "reporting",
    "source_mexiconewsdaily.yaml": "reporting",
    "source_batimes.yaml": "reporting",
    "source_elpais_english.yaml": "reporting",
    "source_aawsat.yaml": "reporting",
    "source_middleeasteye.yaml": "reporting",
    "source_antara.yaml": "reporting",
    "source_meduza.yaml": "reporting",
    "source_rferl.yaml": "reporting",
    "source_abc_australia.yaml": "reporting",
    "source_cbc_world.yaml": "reporting",
    "source_ansa.yaml": "reporting",
    "source_isw.yaml": "analysis",
    "source_stategov_press.yaml": "official",
    "source_un_press.yaml": "official",
    "source_kremlin.yaml": "official",
    "source_euvsdisinfo.yaml": "analysis",
    "source_dfrlab.yaml": "analysis",
    "source_breakingdefense.yaml": "reporting",
    "source_defensenews.yaml": "reporting",
    "source_navalnews.yaml": "reporting",
    "source_oilprice.yaml": "reporting",
    "source_rigzone.yaml": "reporting",
    "source_worldnuclearnews.yaml": "reporting",
    "source_armscontrol.yaml": "analysis",
    "source_guardian_world.yaml": "reporting",
    "source_euronews.yaml": "reporting",
    "source_lemonde_english.yaml": "reporting",
